...
class NewOrderModel {
  ...
  factory NewOrderModel.fromMap(Map<String, dynamic> map) {
    return NewOrderModel(
      ...
      dose_unit_name: map['dose_unit_name'] != null ? map['dose_unit_name'] as String : null,
      base_drug_usage_code: map['base_drug_usage_code'] != null ? map['base_drug_usage_code'] as String : null,
      drug_instruction: map['drug_instruction'] != null ? map['drug_instruction'] as String : null,
      fix_item_type_id: map['fix_item_type_id'] != null ? map['fix_item_type_id'] as String : null,
      item_type_name: map['item_type_name'] != null ? map['item_type_name'] as String : null,
      drug_type_id: map['drug_type_id'] != null ? map['drug_type_id'] as String : null,
  ...
  factory NewOrderModel.fromJson(String source) => NewOrderModel.fromMap(json.decode(source) as Map<String, dynamic>);
