...
class DataNoteModel {
  ...
  DataNoteModel copyWith({
    ...
    return DataNoteModel(
      smw_transaction_order_id:
          smw_transaction_order_id ?? this.smw_transaction_order_id,
  ...
  factory DataNoteModel.fromMap(Map<String, dynamic> map) {
    return DataNoteModel(
      smw_transaction_order_id: map['smw_transaction_order_id'] != null
          ? map['smw_transaction_order_id'] as int
          : null,
      smw_admit_order_id: map['smw_admit_order_id'] != null
          ? map['smw_admit_order_id'] as int
          : null,
      ...
      pre_pare_status: map['pre_pare_status'] != null
          ? map['pre_pare_status'] as String
          : null,
      ...
      file: map['file'] != null
          ? List<FileModel>.from(
              (map['file'] as List<int>).map<FileModel?>(
  ...
  bool operator ==(covariant DataNoteModel other) {
    ...
    return other.smw_transaction_order_id == smw_transaction_order_id &&
