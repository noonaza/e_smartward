                          ...
                          : lPetAdmit.isEmpty
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    String site =
                                        lPetAdmit[index].base_site_branch_id ??
                                            '';
                                  ...
                                  children: [
                                    actionSlider(
                                      ...
                                      action: (controller) async {
                                        if (_isSubmitting) return; // กันกดซ้ำ
                                        _isSubmitting = true;

                                        // ปิด popup ส่งเผื่อมีค้าง
                                        _dismissSendingDialog();

                                        try {
                                          // 1) เช็กเงื่อนไขก่อนส่ง
                                          final hasAnyOrderId =
                                          ...
                                          AwesomeDialog(
                                            ...
                                            desc: e.toString().contains(
                                                    'ไม่พบข้อมูลในระบบ')
                                                ? 'ไม่พบข้อมูลในระบบ กรุณาตรวจสอบรายการและลองใหม่'
                                                : e.toString(),
                                            btnOkOnPress: () {},
                                          ).show();
                                        } finally {
                                  ...
                                  child: lDataNote[realIndex].id != null
                                      ...
                                      : actionSlider(
                                          ...
                                          action: (controller) async {
                                            ...
                                            final isCheckId = itemsWithCheckbox.isEmpty || itemsWithCheckbox
                                                .where((e) =>
                                                    e.smw_transaction_order_id !=
                                                        null)
                                                .isNotEmpty;
