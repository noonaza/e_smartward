...
import 'package:e_smartward/dialog/edit_obs_dialog_v1.dart';
import 'package:e_smartward/dialog/edit_obs_dialog_v2.dart';
import 'package:e_smartward/widget/card_obs_detail_v1.dart';
...
class AdmitScreenV1 extends StatefulWidget {
...
class _AdmitScreenState extends State<AdmitScreenV1> {
                        ...
                        children: [
                          ...
                          ObsListWidget1(
                            ...
                            onEdit: (obs) {
                              ...
                              EditObsDialogV1.showObs(context, obs, index,
                            ...
                            onAdd: () {
                              CreateObsDialogV1.show(context, width: width,
                                  onAddObs: (obs) {
                                setState(() {
