...
//                                                                   try {
//                                                                     // 1) ปิดเมนู SpeedDial ให้เรียบร้อยก่อน แล้วค่อยเปิด dialog
//                                                                     await Future.delayed(Duration(
//                                                                         milliseconds:
//                                                                             0));

//                                                                     // 2) เช็คว่ามีแท็บและคอนโทรลเลอร์พร้อม
//                                                                     if (_tabController ==
//                                                                             null ||
//                                                                         lGroupTabs
//                                                                             .isEmpty) {
...
//                                                                     // 3) resolve visit_id ให้ชัวร์ (จาก AN.list → visit_number ก่อน)
//                                                                     final visitFromAn =
...
//                                                                                 '')
//                                                                             .trim();
//                                                                     final visitId = visitFromAn.isNotEmpty &&
//                                                                             visitFromAn !=
//                                                                                 'null'
//                                                                         ? visitFromAn
//                                                                         : visitFromAdmit;
...
//                                                                     final tempPet = (visitFromAdmit.isNotEmpty &&
//                                                                             visitFromAdmit !=
//                                                                                 'null')
//                                                                         ? mPetAdmit_!
//                                                                         : (ListPetModel()
...
//               requestedOnce = true;
//               WidgetsBinding.instance.addPostFrameCallback((_) {
//                 refreshOrders(setState); // ✅ เรียกหลัง dialog mount แล้ว
//               });
//             }
...
//                             FilledButton.icon(
//                               onPressed: () async {
//                                 // โหลดข้อมูลล่าสุดให้หน้าหลักก่อนปิด
//                                 showDialog(
//                                   context: ctx,
//                                   barrierDismissible: false,
//                                   builder: (_) => const Center(
